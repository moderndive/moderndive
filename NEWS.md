...
- v0.4.0 of [ModernDive](https://moderndive.github.io/moderndive_book/) textbook by including `evals`, `house_prices`, `pennies_sample`, and `mythbusters_yawn` data frames
