...
#' charging session.
#' \describe{
#'    \item{sessionId}{unique identifier specifying the electric vehicle charging session}
#'    \item{kwhTotal}{total energy used at the charging session, in kilowatt hours (kWh)}
...
#'    \item{startTime}{hour of the day when the charging session began (1 through 24)}
#'    \item{endTime}{hour of the day when the charging session ended (1 through 24)}
#'    \item{chargeTimeHrs}{length of the charging session in hours}
...
#'    \item{userId}{unique identifier for each driver}
#'    \item{stationId}{unique identifier for each charging station}
#'    \item{locationId}{unique identifier for each location owned by the company where charging stations
#'    were located}
#'    \item{managerVehicle}{binary variable that is 1 when the vehicle is a type commonly used
#'    by managers of the firm and 0 otherwise}
#'    \item{facilityType}{categorical variable that represents the facility type:
#'    \itemize{
