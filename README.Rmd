...
An R package of datasets and wrapper functions for [tidyverse](https://www.tidyverse.org/)-friendly introductory linear regression used ""Statistical Inference via Data Science: A ModernDive 
#' into R and the tidyverse"" available at [ModernDive.com](https://moderndive.com/).
