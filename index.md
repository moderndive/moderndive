...
function from the `knitr` package, you can obtain aesthetically pleasing
regression tables in R Markdown documents, instead of tables written in
...
residuals.](reference/figures/residuals-1-1.png)
...
age.](reference/figures/residuals-2-1.png)
...
homepage.](reference/figures/kaggle.jpeg)
...
score.](reference/figures/leaderboard_orig.jpeg)
...
models.](reference/figures/interaction-and-parallel-slopes-model-1-1.png)
...
![Interaction (left) and parallel slopes (right)
models.](reference/figures/interaction-and-parallel-slopes-model-2-1.png)
