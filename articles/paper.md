...
As an improvement to base R’s regression functions, we’ve included three
functions in the `moderndive` package that take a fitted model object as
input and return the same information as
...
model.](paper_files/figure-html/interaction-model-1.png)
...
model.](paper_files/figure-html/parallel-slopes-model-1.png)
